...
public class OpenZnContractControllerSell {
    ...
    public void initialize() {
        ...
        List<ContractsOpenSell> contractsOpenSells = daoAllViewController.selectList().stream().filter(e->e.getIdName().equals(daoAllViewControllerMaterial.findById(4).getName())).collect(Collectors.toList());;
