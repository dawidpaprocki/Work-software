...
//        assertEquals("Test1 Material", addedSelect.get(1).getMaterialName());
...
//        List<ContractsOpenSell> addedSelect = dao.select();
//        int columnId = addedSelect.get(0).getId();
//
//
//        daoContractsOpenSellController.update(columnId, 3, 3, "Changed",
...
//        assertEquals("Changed", updateSelect.get(0).getMaterialName());
...
//        int columnId = addedSelect.get(0).getId();
//
//        daoContractsOpenSellController.updateRecord("MaterialName", "Test1", columnId);
//        ContractsOpenSell byId = (ContractsOpenSell) dao.findById(columnId);
//        assertEquals(byId.getMaterialName(), "Test1");
//
//    }
//    @Test
...
//        int columnId = addedSelect.get(0).getId();
//
//        daoContractsOpenSellController.updateRecord("ContractName", "u", columnId);
//        ContractsOpenSell byId = (ContractsOpenSell) dao.findById(columnId);
