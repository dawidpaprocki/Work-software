...
//
//        // given
//        int columnId = getCustomerId();
//        // when
//        daoCustomerController.update(columnId, "TestAfterChange", "CountryAfterChange");
//        List<Customer> select = dao.select();
//        List<String> collectName = select.stream().map(Customer::getName).collect(Collectors.toList());
//        List<String> collectCountry = select.stream().map(Customer::getCountry).collect(Collectors.toList());
//        // then
...
////        int columnId = getCustomerId();
////        // when
////        daoCustomerController.remove(columnId);
////        List<Customer> select = dao.select();
////        // then
...
////        int columnId = getCustomerId();
////        // when
////        customer = daoCustomerController.findById(columnId);
////        // then
////        assertEquals(customer.getId(), columnId);
////
////    }
////
////    @Test
...
////        customer = daoCustomerController.findById(columnId);
////        // then
////        assertNotEquals(customer.getId(), columnId + 1);
////
////    }
////
////    @Test
